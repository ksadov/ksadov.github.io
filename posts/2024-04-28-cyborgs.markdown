...
Couldn't you argue that there is an implicit context for "good" in the linked thread, namely "writing that induces the LLM to generate competent ouput"? Yes, but this renders the comments tautological. Janus is clearly making an aesthetic judgement, declaring some kinds of writing to be more meritous than others independently from whether they accomplish the desired task.
